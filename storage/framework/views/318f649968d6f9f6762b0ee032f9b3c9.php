...
<div class="card mt-2">
    <div class="card-header">
        ...
        <div class="row">
            ...
            <div class="col-md-6" align="right">
                <a href="<?php echo e(route('stock.add')); ?>"> Add New</a>
            </div>
        </div>
    </div>
    <div class="card-body">
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#list-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(url('/api/stock-list')); ?>",
                    headers: {
            ...
            table.on('click', '.deleteStock', function(e) {
                ...
                var url = '<?php echo e(url("/api/stock-delete/:id")); ?>'.replace(':id', delId);
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\WebApps\htdocs\DKInfoway\resources\views/stock/list.blade.php ENDPATH**/ ?>