    ...
    if (AuthToken) {
        ...
        authSection.innerHTML = `
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo e(route('stock.list')); ?>">Stock</a>
                </li>
            </ul>
            <div class="d-flex">
        ...
        authSection.innerHTML = `
            ...
            <div class="d-flex justify-content-end">
                <a class="btn btn-primary" href="<?php echo e(route('auth.login')); ?>">Login</a>
            </div>
        `;
    }
</script>
...
</html><?php /**PATH H:\WebApps\htdocs\DKInfoway\resources\views/master-layout.blade.php ENDPATH**/ ?>