    ...
    $(document).ready(function() {
        ...
        $('#inquiry-form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('api/login-user')); ?>",
                    data: $(form).serialize(),
                    success: function(response, status, xhr) {
                        if (xhr.status === 200) {
                            ...
                            // Redirect
                            setTimeout(() => {
                                location.href = "<?php echo e(route('stock.list')); ?>";
                            }, 2000);
                        } else {
                            // Error message
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\WebApps\htdocs\DKInfoway\resources\views/auth/login.blade.php ENDPATH**/ ?>